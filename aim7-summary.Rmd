...
data_with_comorbid |>
  filter(!is.na(sys_comorbid_burden_0)) |>
...
The only record missing (NA) was the `52-0023` record, which doesn't need to be queried.
...
Additionally, these records have an unusually high unit count and should be queried. We suspect many of these simply misinterpreted the question and answered in terms of volume not units of blood.
