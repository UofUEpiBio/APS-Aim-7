...
## (WIP - STARTED) Acute Allergic Reaction -- Streamlined DAG

**Variable Definition:**

Binary variable:

- 0 = No suspected anaphylaxis if `organ_dysnfx_cause` = 1, 3, OR 99 OR
      `organ_dysnfx_inflam` is not related to allergic reaction or anaphylaxis
- 1 = Suspected anaphylaxis if `organ_dysnfx_cause` = 2 AND
      `organ_dysnfx_inflam` is related to allergic reaction or anaphylaxis
...
```{r}
data_with_allergic |>
  filter(str_acute_allergic_reaction_0 == 99) |>
  select(
    record_id,
    organ_dysfnx_cause,
    organ_dysfnx_inflam_descr
...
```{r}
data_with_allergic |>
  filter(is.na(str_acute_allergic_reaction_0)) |>
  select(
    record_id,
    organ_dysfnx_cause,
    organ_dysfnx_inflam_descr
...
## (WIP - STARTED) Diffuse Alveolar Hemorrhage -- Streamlined DAG

**Variable Definition:**

Binary variable (likely not used in primary analysis):

- 0 = No DAH if `organ_dysnfx_cause` = 1, 3, OR 99 OR
      `organ_dysnfx_inflam` is not related to DAH
- 1 = Suspected DAH if `organ_dysnfx_cause` = 2 AND
      `organ_dysnfx_inflam` is related to DAH
...
## (WIP - STARTED) Acute Inflammatory Drug Toxicity -- Streamlined DAG

**Variable Definition:**

Binary variable (likely not used in primary analysis):

- 0 = No acute inflammatory drug reaction if `organ_dysnfx_cause` = 1, 3, OR 99 OR
      `organ_dysnfx_inflam` is not related to acute inflammatory drug reaction
- 1 = Suspected acute inflammatory drug reaction if `organ_dysnfx_cause` = 2 AND
      `organ_dysnfx_inflam` is related to acute inflammatory drug reaction
...
```{r}
data_with_drug_toxicity |>
  filter(is.na(str_drug_toxicity_0)) |>
  select(
    record_id,
    organ_dysfnx_cause,
    organ_dysfnx_inflam_descr
...
## (WIP - STARTED) Acute Cryptogenic Organizing Pneumonia -- Streamlined DAG

**Variable Definition:**

Binary variable (likely not used in primary analysis):

- 0 = No acute COP if `organ_dysnfx_cause` = 1, 3, OR 99 OR
      `organ_dysnfx_inflam` is not related to acute COP
- 1 = Suspected acute COP if `organ_dysnfx_cause` = 2 AND
      `organ_dysnfx_inflam` is related to acute COP
