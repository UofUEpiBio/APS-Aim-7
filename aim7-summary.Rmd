...
## Systematic DAG: Chronic Moderate-Dose Steroid Use
...
These records were missing the fields required to assess this variable. This is the same record that is missing the "Daily In-Hospital Forms" event data.

```{r}
data_with_sys_chron_steroid_moddose_0 |>
  filter(is.na(sys_chron_steroid_moddose_0)) |>
  select(record_id, mhccster, m_endocrine, m_endo_conditions___2, m_immunosuppression, m_immunosup_conditions___1) |>
  gt()
```

## Streamlined DAG: Chronic Moderate-Dose Steroid Use
...
```{r}
data_with_str_chron_steroid_moddose_0 |>
  filter(is.na(str_chron_steroid_moddose_0)) |>
  select(record_id, mhccster, m_endocrine, m_endo_conditions___2, m_immunosuppression, m_immunosup_conditions___1) |>
  gt()
```
...
- 0 (No) = `(m_pulm_conditions__6 == 0)`
- 1 (Yes) = `(m_pulm_conditions__6 == 1)`
...
## Systematic DAG: Obstructive Lung Disease
...
## Streamlined DAG: Obstructive Lung Disease

Currently calculated the same as Systematic DAG: Obstructive Lung Disease (see above).

## (WIP) Systematic DAG: Active SARS-CoV-2 Infection
...
## Streamlined DAG: Chronic Immunocompromise

Currently calculated the same as Systematic DAG: Chronic Immunocompromise (see above).

## (WIP) Systematic DAG: Hyperglycemia

### Summary

## (WIP) Streamlined DAG: Hyperglycemia

### Summary

## (WIP) Systematic DAG: Active Influenza Infection

### Summary

## (WIP) Streamlined DAG: Active Influenza Infection
