...
The record `52-0023` has almost no useable data because it was erroneously included in the `N=500` data set. It was filtered out before deriving the variables below. Consequently, the total counts for any given variable will sum to 499 not 500.
...
## (AWAITING REWORK) Presence of ARDS Syndrome -- Systematic & Streamlined DAG
...
## (AWAITING REWORK) Presence of Pneumonia Syndrome -- Systematic & Streamlined DAG
