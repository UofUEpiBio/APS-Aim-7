...
data_aps_vars <- data_aps_vars |>
  mutate(
    # Calculate respiratory support type for day 0 (no lookback for now)
...
This better highlights the records that couldn't be classified under the Global Physiology Severity DAG. Only one record (`52-0023`, excluded from the dataset) is missing all components of the APS score. The others are missing several components, often with a given record missing several related components.
